...
#page(header: none, footer: none, numbering: none)[
  #align(center)[
    ...
    #v(8pt)
    #text(size: 10pt, fill: rgb("#666"))[User manual · package version 0.2.0]
  ]
]
...
module — e.g. `#import "@preview/staunton:0.2.0/src/coords.typ": square-name` —
