...
#page(header: none, footer: none, numbering: none)[
  #align(center)[
    ...
    #v(8pt)
    #text(size: 10pt, fill: rgb("#666"))[User manual · package version 2.0.0]
  ]
]
...
```typ
#import "@preview/staunton:2.0.0": board as chessboard, diagram as chessdiagram
```
...
```typ
#import "@preview/staunton:2.0.0": chess-table-kind
...
module — e.g. `#import "@preview/staunton:2.0.0/src/coords.typ": square-name` —
