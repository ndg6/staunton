...
#let s(src, ..a) = notation(src, ..((diagrams: false, bold-mainline: false, nags: true, comments: false, variations: false, lang: "en") + a.named()))
...
#assert(
  notation(g2, diagrams: false, bold-mainline: false, nags: false, comments: false, variations: false, lang: "en") == "1.e4 e5 2.Nf3 Nc6",
