...
#import "/lib.typ": game, notation, with-nags, with-comments

#set page(width: auto, height: auto, margin: 1cm)
#set text(font: "Libertinus Serif", size: 10pt)

#let g = game("[White \"A\"][Black \"B\"] 1. e4 e5 2. Nf3 Nc6 3. Bb5 (3. Bc4 Bc5) a6 *")
...
#assert(s(with-nags(g, nags: ("3w": "!"))) == "1. e4 e5 2. Nf3 Nc6 3. Bb5! (3. Bc4 Bc5) 3... a6", message: "mainline nag, dict form")
// --- with-nags: same via the array-of-pairs form ----------------------------
#assert(s(with-nags(g, nags: (("3w", "!"),))) == "1. e4 e5 2. Nf3 Nc6 3. Bb5! (3. Bc4 Bc5) 3... a6", message: "mainline nag, pairs form")
// --- with-nags: a move INSIDE the variation (path locator) ------------------
#assert(s(with-nags(g, nags: ((bc4, "!!"),))) == "1. e4 e5 2. Nf3 Nc6 3. Bb5 (3. Bc4!! Bc5) 3... a6", message: "nag inside a variation")

// --- with-comments: mainline and inside a variation -------------------------
#assert(s(with-comments(g, comments: ("3w": "main note"))) == "1. e4 e5 2. Nf3 Nc6 3. Bb5 main note (3. Bc4 Bc5) 3... a6", message: "comment on a mainline move")
#assert(s(with-comments(g, comments: ((bc4, "sharp"),))) == "1. e4 e5 2. Nf3 Nc6 3. Bb5 (3. Bc4 sharp Bc5) 3... a6", message: "comment inside a variation")

// --- composition: build up, then render as one ------------------------------
#assert(
  s(with-comments(with-nags(g, nags: ("3w": "!")), comments: ((bc5, "counter"),)))
    == "1. e4 e5 2. Nf3 Nc6 3. Bb5! (3. Bc4 Bc5 counter) 3... a6",
  message: "compose with-comments . with-nags",
)

// --- the source game is never mutated ---------------------------------------
#let _ = with-nags(with-comments(g, comments: ((bc4, "x"),)), nags: ("3w": "?"))
#assert(s(g) == base, message: "source untouched after building")

= Phase 1 builders
#s(with-comments(with-nags(g, nags: ("3w": "!")), comments: ((bc4, "the alternative"),)))
