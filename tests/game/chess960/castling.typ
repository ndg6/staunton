...
#import "/lib.typ": chess-moves, parse-fen, to-fen, legal-moves

#set page(width: auto, height: auto, margin: 1cm)

// O-O with the king on f1 and its rook on g1: king f1->g1, rook g1->f1.
#let a = chess-moves("4k3/8/8/8/8/8/8/5KR1 w K - 0 1", "O-O")
...
#let b = chess-moves("4k3/8/8/8/8/8/8/RK6 w Q - 0 1", "O-O-O")
...
#let c = chess-moves("4k3/8/8/8/8/8/8/6KR w K - 0 1", "O-O")
