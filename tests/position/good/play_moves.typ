...
#let final = play-moves(start, "Bb5 a6 Ba4 Nf6")
...
#let from-start = play-moves(none, "1. e4 e5 2. Nf3 Nc6")
...
= play-moves: the Ruy Lopez, built from move text

#chess-diagram(final, size: 5cm,
  caption: [After 3.Bb5 a6 4.Ba4 Nf6, from `play-moves`.])
