...
#import "/lib.typ": chess-diagram-outline, chess-table-outline, chess-diagram, starting-fen

#set page(width: 12cm, height: auto, margin: 1cm)

#chess-diagram-outline(title: none)
#chess-table-outline(title: none)
#chess-diagram(starting-fen, size: 2cm, caption: [Listed])

#context {
  // The only heading-bearing element here is nothing: neither outline emitted a
  // title, and a chess-diagram is a figure, not a heading.
