...
#assert(chess-notation(g, lang: "de", nags: false, comments: false, diagrams: false, bold-mainline: false, variations: false) == "1.e4 e5 2.Sf3 Sc6 3.Lb5 a6", message: "explicit de notation")
#context {
