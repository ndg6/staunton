...
// Plain pawn push.
#let start = position(starting-fen)
#assert(move-to-san(start, move-at(start, "e2", "e4")) == "e4", message: "plain pawn push")

// Pawn capture.
#let cap-pos = position("4k3/8/8/3p4/4P3/8/8/4K3 w - - 0 1")
...
#let ep-pos = position("4k3/8/8/3pP3/8/8/8/4K3 w - d6 0 1")
...
#let promo-pos = position("k7/4P3/8/8/8/8/8/4K3 w - - 0 1")
#assert(
...
#let promo-cap-pos = position("2r5/1P1P4/8/8/8/8/8/4K2k w - - 0 1")
#assert(
...
#let stale-pos = position("k7/8/8/2Q5/8/8/8/6K1 w - - 0 1")
...
#let mate-pos = position("6k1/5ppp/8/8/8/8/8/R3K3 w - - 0 1")
...
#let castle-pos = position("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1")
...
#let file-pos = position("3R4/8/8/8/k7/8/8/5R1K w - - 0 1")
...
#let rank-pos = position("4k3/8/8/8/R7/8/8/R3K3 w - - 0 1")
...
#let three-q-pos = position("8/8/k7/8/1Q5Q/8/8/K6Q w - - 0 1")
...
#let pin-pos = position("4r2k/8/8/4R3/8/8/8/1R2K3 w - - 0 1")
