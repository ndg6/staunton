...
#import "/lib.typ": parse-pgn, movetext, with-nags, position-after, notation
#import "/src/game.typ": _origin-of

// --- plain suffix glyph is stripped, converted to the matching NAG ----------
#let g1 = parse-pgn("1. e4! e5 *").first()
...
#let g2 = parse-pgn("1. e4 e5 2. Bc4 Nc6 3. Qh5 Nf6 4. Qxf7#!! *").first()
...
#let g3 = parse-pgn("1. e4! $1 e5 *").first()
...
#let g4 = parse-pgn("1. e4! $14 e5 *").first()
...
#let g5 = parse-pgn("1. e4 e5 (1... c5! 2. Nf3) *").first()
...
#let g6 = parse-pgn("1. e4! e5? 2. Nf3!! Nc6?? 3. Bb5!? a6?!").first()
...
#let g7 = parse-pgn("1. e4!!! e5?!? *").first()
...
#let g8 = parse-pgn("1. e4 ?! e5 *").first()
...
#assert.eq(
  position-after(parse-pgn("1. e4 e5 2. Nf3! *").first(), "2w").at("_origin").quality,
  (square: "f3", symbol: "!"),
