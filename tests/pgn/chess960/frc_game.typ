...
#import "/lib.typ": game, game-variant, game-start, to-fen, play, board, diagram
...
#assert(_position-after(g, at: "2b").squares == via-cm.squares, message: "pgn replay != play")

// After both sides castle king-side: kings on g, rooks on f, castling gone.
#assert(
  to-fen(_position-after(g, at: "2b")) == "nrbbqrk1/pppppppp/5n2/8/8/5N2/PPPPPPPP/NRBBQRK1 w - - 4 3",
  message: "final: " + to-fen(_position-after(g, at: "2b")),
)

= Chess960 game replay

#board(start960, size: 4cm)
#diagram(g, at: "2b", size: 4cm,
