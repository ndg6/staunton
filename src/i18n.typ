...
//
// Each `assets/i18n/<code>.typ` exports a `piece-chars` dict mapping a piece
...
//
// Adding a language is a no-code change: drop `assets/i18n/<code>.typ` exporting
// `piece-chars`, then add one line to `notation-langs` below.
// ===========================================================================
