// Microbench: SAN replay — _position-after walking the whole mainline (this
// drives san-to-move + apply for every move of the game).
//
// See parse.typ for the n-parameterisation / self-baseline scheme.
//
// Memoisation defeat: _position-after memoises the mainline replay on the game
...
#for i in range(n) {
  ...
  acc += _position-after(probe, at: loc).squares.len()
}
#acc
