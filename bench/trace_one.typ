// Single-g trace target for `typst compile --timings`.
//
// The full 9-g bench/spassky_fischer.typ produces a ~600 MB timings trace,
...
// g, so it is a good single-g stand-in.
